 <?php
    class CaisseController
    {
        ...
        {
            $db = $this->connectDb();
            $query = "INSERT INTO caisse (type, amount, statut, date) VALUES (:type, :amount, :statut, :date)";
        ...
        {
            $db = $this->connectDb();
            $query = "UPDATE caisse SET type = :type, amount = :amount, statut = :statut, date = :date WHERE id = :id";
            $stmt = $db->prepare($query);
            $stmt->execute([
                'id' => $id,
                'type' => $type,
        ...
        {
            $db = $this->connectDb();
            $query = "DELETE FROM caisse WHERE id = :id";
            $stmt = $db->prepare($query);
            $stmt->execute(['id' => $id]);
        }
        ...
        {
            $db = $this->connectDb();
            $query = "SELECT * FROM caisse WHERE statut = :statut";
            $stmt = $db->prepare($query);
        ...
        {
            $db = $this->connectDb();
            $query = "SELECT * FROM caisse WHERE date = :date";
            $stmt = $db->prepare($query);
        ...
        {
            $db = $this->connectDb();
            $query = "SELECT * FROM caisse WHERE type = :type";
            $stmt = $db->prepare($query);
        ...
        {
            $db = $this->connectDb();
            $query = "SELECT type, SUM(amount) as total FROM caisse WHERE statut = :statut GROUP BY type";
            $stmt = $db->prepare($query);
            $stmt->execute(['statut' => $statut]);
            return $stmt->fetchAll();
        }
        ...
        {
            $db = $this->connectDb();
            $query = "SELECT SUM(amount) as total FROM caisse WHERE statut = :statut";
            $stmt = $db->prepare($query);
            $stmt->execute(['statut' => $statut]);
            $result = $stmt->fetch();
